...
<div class="Bfestad">
  <div class="est-cont1">
    <div class="est-online">
      ...
      <div class="con-on">Conectados</div> 
    </div>
    <div class="est-offline">
      <div class="uss-not">{L_CONNECTED_MEMBERS}</div>
      <div class="con-off">Hace 48 horas</div>
    </div>
  ...
  <div class="est-cont3">
    <div class="estad"> 
      ...
      <div class="est-pos">{TOTAL_POSTS} <em>Post</em></div> 
    </div>
  ...
  <div class="est-cont4">
      ...
      <div class="est-post">Cerrado</div>
        ...
        <img src="https://i.ibb.co/gFfrSpPF/gatodelasuerte.png" />
      </div>
  </div>
</div>
